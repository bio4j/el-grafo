...
var mainGraphWidth = 700;
var mainGraphHeight = 500;
...
rectHeightGraph = 50;
svgGraphLegend.append("rect")
          .attr("x", 0)
          .attr("y", mainGraphHeight-rectHeightGraph)
          .attr("width", mainGraphWidth)
          .attr("height", rectHeightGraph)
          .style("fill", "blue")
          .style("opacity", 1);

rectHeightArity = 150;
svgGraphLegend.append("rect")
          .attr("x", mainGraphWidth-rectHeightArity)
          .attr("width", rectHeightArity)
          .attr("height", 150)
          .style("fill", "white")
...
/*          .attr("d", function(d, i) { 
            ...
            return "M480," + Ycord + "L520," + Ycord  })*/
          .attr("d", function(d, i) { 
            var Ycord = +50 + (i*verticalSeparation);
            return "M"+(mainGraphWidth-rectHeightArity)+"," + Ycord + "L"+((mainGraphWidth-rectHeightArity)+legendLength)+"," + Ycord  })
          .style("stroke-width", .3)          
          .style("stroke", colorMod)
          .attr("marker-end", "url(#arrowhead)");
...
svgGraphLegend.append("path")
        .attr("class", "pathLegend")
        .attr("d", "M"+(mainGraphWidth-rectHeightArity)+"," +(75+offset2)+",510,75"+ "L"+((mainGraphWidth-rectHeightArity)+legendLength)+"," + "75")
        .style("stroke", colorMod)
        .style("stroke-width", .3)
        .style("fill", "none");
...
svgGraphLegend.append("path")
        .attr("class", "pathLegend")
        .attr("d", "M"+(mainGraphWidth-rectHeightArity)+",100,500,100"+ "L"+((mainGraphWidth-rectHeightArity)+legendLength)+"," + (+100+offset2))
        .style("stroke", colorMod)
        .style("stroke-width", .3)
        .style("fill", "none");
...
svgGraphLegend.append("path")
        .attr("class", "pathLegend")
        .attr("d", "M"+(mainGraphWidth-rectHeightArity)+",100,"+(((mainGraphWidth-rectHeightArity)+(legendLength)/2))+",100"+ "L"+((mainGraphWidth-rectHeightArity)+legendLength)+"," + (+100-offset2))
        .style("stroke", colorMod)
        .style("stroke-width", .3)        
        .style("fill", "none");
...
svgGraphLegend.selectAll("text2")
          ...
          .append("text")
          .attr("id", "legendText")
          .attr("x", ((mainGraphWidth-rectHeightArity)+(legendLength))+10)
